...
var Events = {
	...
	addEvent: function(name, method){
		// console.log('< addEvent', {_this:this, name:name, method:method}); 
	...
	fireEvent: function(name, args){
		// console.log('> fireEvent', {_this:this, name:name, args:args}); 
...
// Simple underpowered string-based html builder
...
var Build = (function(){
	...
	function buildTag(tag, attrs, html){
		...
		console.log(html);
		if (tag=='table'){
			html = buildTags('tr', attrs.tr||{td:attrs.td||{}}, html.toString());
			delete attrs.tr;
		}
		if (tag=='tr'){
			html = buildTags('td', attrs.td||{}, html.toString());
			delete attrs.td;
		}
		if (tag=='ul' || tag=='ol'){
			html = buildTags('li', attrs.li||{}, html.toString());
			delete attrs.li;
		}
		// tag = html.tag || tag;
