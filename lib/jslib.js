...
Number.setCompare = function(key, value){
	value = value-0;
	Number.getCompare.comparisons = Number.getCompare.comparisons || {};
	var c = Number.getCompare.comparisons[key] = Number.getCompare.comparisons[key] || {values:[]};
	
	c.values.push(value);
	c.values = c.values.sort(Array.numberSorter);
