					...
					do {++this.data.countRuns;
						...
						// try {
							do {++this.data.countIterations;
								...
								run.time = iteration.time = run.end - run.start;
							} while (
								...
								// (
								// 	 ( run.iterTime < MIN_ITER_TIME )||
								// 	!( run.iterTime > MAX_ITER_TIME )
								// )&&(
						...
						// 	 ( run.runTime < MIN_RUN_TIME )||
						// 	!( run.runTime > MAX_RUN_TIME )
						// )&&(
